...
const fixTopBBCStory = () => {
  ...
  topStoryTitleEl.innerText = "Nicolas becomes favourite Atomic Gittens' instructor."
}
...
function fixTweet () {
  ...
  tweetText.innerText = "I just can't believe how quickly Nicolas became favourite Atomic Gittens' lead instructor. This is huge! So proud, I'm so proud."
}
